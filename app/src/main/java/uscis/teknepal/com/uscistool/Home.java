...
import static uscis.teknepal.com.uscistool.R.anim.abc_slide_in_bottom;
import static uscis.teknepal.com.uscistool.R.anim.abc_slide_in_top;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    ...
                    ActivityOptions options = ActivityOptions.makeCustomAnimation(context, abc_slide_in_bottom, abc_slide_in_bottom);
                ...
                case R.id.navigation_dashboard:
                    ...
                    ActivityOptions option = ActivityOptions.makeCustomAnimation(context, abc_slide_in_bottom, abc_slide_in_bottom);
                    // Launch the Activity using the intent
                ...
                case R.id.navigation_notifications:
                    ...
                    ActivityOptions opt = ActivityOptions.makeCustomAnimation(context, abc_slide_in_top, abc_slide_in_top);
...
//My logic for Button goes in here
    ...
    private void updateQuestion() {
        if (mQuestionNumber < mQuestion.getCount()) {
    ...
    private void updateScore(int score) {
        score_text.setText(String.format("%s%s", getString(R.string.score), format("%d", score)));
    }
    ...
    private void quizEnd() {
        ...
        if (mScore > 6) {
            ...
            result.setText(R.string.better_luck);
            result.setTextColor(Color.RED);
            result.setTextSize(24);
        }


        score_text.setText(getString(R.string.final_score) + format("%d", mScore));
...
//        score_text.setTextSize(50);
    ...
    private int randomNum() {
        ...
        int j = 0;
        for (int l = 1; l < mQuestion.getCount(); l++) {
            list.add(l);
        }
        Collections.shuffle(list);
        for (int i = 0; i < 1; i++) {
            j = list.get(i);
            //mScoreView.setText(i);
        }
        return j;
    }
}